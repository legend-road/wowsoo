...
window.SOO = {
  ...
  sourceNote:
    "以英雄难度为主（MythicTrap Heroic / WCL），并吸收 NGA 25H 实战；普通与英雄相同的机制一并说明，英雄专属已用【英雄】标注。演示视频来自 MythicTrap CDN。",
  ...
  bosses: [
    {
      ...
      summary:
        "目标不是“打死血条”，而是把腐蚀（Corruption）从 100 清到 0。本体阶段把血压到 0% 会分裂成黑软（煞能水滴）与白软（污染水滴）；击杀黑软或奶满白软各减 1 点腐蚀。重组后 Boss 血量百分比≈剩余腐蚀。硬狂暴约 10 分钟。英雄：本体阶段有「肿胀腐蚀」叠层需分波处理；分裂阶段中央煞池会膨胀，需减伤轮流短踩缩小。",
      media: [
        {
    ...
    },
    {
      ...
      summary:
        "石蹄洛克、软足何、慈心孙三人不共享血量。各自在 66% / 33% 进入「绝命措施」离场刷化身（期间 Boss 身上 DoT 仍会继续跳）。控伤按顺序触发绝命，禁止多人同时绝命。斩杀时三人必须几乎同时到 1%——否则「金莲之缚」回约 30% 血。英雄加压：酒桶飞行加速；洛克化身共享血量；衰弱更狠（约 80% 减甲、持续约 4 分钟）；孙的灾祸伤害递增。",
      skills: [
        {
        ...
        {
          name: "【英雄】机制加压",
          desc: "腐化酒桶飞行速度随战斗加快，躲闪窗口更短。洛克绝命化身共享血量，可合理 cleave。何的「衰弱」约 80% 减甲且持续约 4 分钟（普通约 50%/2 分钟）——印记传递更要短持、强减。孙的灾祸伤害递增，后期必须对齐大减伤。",
          who: "全团",
        },
      ],
      mechanics: [
        ...
        "洛克绝命：分摊哀伤 → 打断阴郁 → 悲苦拉外放黑圈；英雄化身可顺劈。",
        "何绝命：免疫/强减持印记短传；英雄衰弱更狠，严禁乱传叠层。",
        "孙绝命：全员进中央力场；平时灼烧优先打断、祸秒驱；英雄后期灾祸必开大减伤。",
      ],
      positioning:
    ...
    },
    {
      ...
      summary:
        "真正对手是「腐蚀混合物」（Amalgam of Corruption），诺鲁什是协助者。全员开场 75 腐蚀（上限 100），腐蚀越高对混合物伤害越低。与「净化之光」互动进入职责考验，成功则腐蚀归 0 并获得「净化」职责增益。考验应分波进入，保证外场仍能处理小怪。约 7 分钟硬狂暴。英雄唯一机制差异：浸泡「残留腐蚀」圈会给浸泡者 +25 腐蚀——排班时预留再次考验/净化的人手。",
      skills: [
        {
      ...
      mechanics: [
        ...
        "【英雄】残留圈：≤75 腐蚀者踩；踩完 +25 腐蚀，预留再净化人手。",
        "7 分钟硬狂暴，嗜血常见交在约 50%。",
      ],
      positioning:
    ...
    },
    {
      ...
      summary: "全员从 0 傲气开始累积；Boss 能量满施放「肿胀傲气」造成全团暗影伤害并 +5 傲气，再按当前傲气档位触发额外惩罚。100 傲气「克服」：生命翻倍并永久心控。诺鲁什每 25 秒赐「泰坦之赐」（约 20 秒免疫傲气），集合叠「泰坦之力」。30% 释放后约 200 秒软狂暴。英雄额外：10 人放逐 1 人 / 25 人放逐 3 人进煞迷宫（留腐化碎片在外场，打掉碎片才能回）；全程刷腐蚀裂隙，踩关会自伤+8 码溅射，并上「虚弱决心」约 1 分钟不能再踩。",
      skills: [
        {
        ...
        },
        {
          ...
          desc: "10 人点 1 人 / 25 人点 3 人：被放逐进煞领域，外场留下「腐化碎片」。外场必须尽快击杀碎片，被放逐者才能回来。迷宫内只能向前跑，撞墙吃暗影伤；捡「光明宝珠」可自疗，并对碎片叠约 +25% 受伤。碰到小煞「虚灵腐蚀」会秒杀。外场组：秒碎片；迷宫组：捡球、躲煞、别撞墙。",
          who: "被点名 / 外场 DPS",
          video: "https://assets2.mythictrap.com/videos/siege-of-orgrimmar/sha-of-pride/banishment.mp4"
        },
        {
          name: "【英雄】腐蚀裂隙 / 不稳定腐蚀",
          desc: "全程周期性刷裂隙：对随机玩家暗影伤并每次 +5 傲气。踩上去可关闭裂隙，自身与 8 码内吃中等暗影伤，并获得「虚弱决心」约 1 分钟内不能再关裂隙。按象限轮班踩，勿多人挤在同一裂隙上。",
          who: "机动 / 全员",
      ...
      mechanics: [
        ...
        "【英雄】放逐：外场秒碎片；迷宫捡光明球给碎片易伤，躲开虚灵腐蚀。",
        "【英雄】裂隙：象限轮班踩关，注意 1 分钟虚弱 CD 与 8 码溅射。",
        "30% 释放阶段开嗜血爆发；约 200 秒硬时限前必须击杀。"
      ],
      positioning: "常规在 Boss 附近集合吃赐福与泰坦之力，并预留牢房激活的安全距离。肿胀与高傲气光环时临时散开。保持近战位。英雄按象限分工关裂隙，放逐碎片刷点附近预留转火位。",
      roles: {
        tank: "受伤的傲气期间立刻换坦；始终保持近战位；协助拉具现/反射/碎片。",
        healer: "轮流驱散傲慢印记，优先赐福窗口；肿胀与释放阶段群抬；关注牢房、裂隙溅射与迷宫归来血线。",
        dps: "优先转火具现/碎片并打断；顺劈反射；控傲气；赐福集合；按表踩裂隙。"
      },
      notes: "英雄卡关常见：碎片不秒导致迷宫回不来、裂隙无人踩傲气暴涨、虚弱 CD 叠班、牢房未及时解锁、投影超时、驱散冲到 100、30% 后拖过约 200 秒。",
    ...
    },
    {
      ...
      summary: "两阶段。P1 约 8 波地面增援，同时清双塔占防空炮；两侧炮同时开火迫降。转火：治疗潮图腾与战旗 → 投石车/碎骨者 → 其余。P2 火球多人拦截减免爆炸，硬顶脉冲火焰软狂暴。友方 NPC 死亡即灭团。英雄：小怪血伤更高；塔门不会自动开，需护送友方 NPC 约 90 秒解锁（死亡则重置），左右塔各派护卫组。",
      skills: [
        {
          name: "战旗（War Banner）",
      ...
      mechanics: [
        ...
        "【英雄】波 4/8 前派人护塔门 NPC 约 90 秒，勿让 NPC 死。",
        "双塔炮位就绪后尽量同时开炮再进 P2，可先清干净地面。",
        "P2 火球用站位链拦截；嗜血常见交 P2。友方 NPC 死亡即灭团。"
      ],
    ...
    },
    {
      ...
      summary: "严格计时两阶段循环：突击模式恰好 2 分钟（可移动、有近战）→ 攻城模式 1 分钟（原地、不近战）再循环。突击处理钻孔尖刺、迫击、火焰喷射换坦与爬行地雷；攻城有震波击退（背靠墙）、爆炸焦油、切割激光（绝不可拖进焦油）、地震脉冲与攻城炮。约每 20 秒身后刷 3 枚地雷，6 秒内未近战右键踩灭会团爆。英雄：突击刷弹跳锯片需躲开；攻城额外迫击弹幕，常用墙边集合减伤硬顶、仅激光点名短暂出列。",
      skills: [
        {
          name: "钻孔（Borer Drill）",
    ...
    },
    {
      ...
      summary: "破地者哈洛姆与缚潮者卡德里斯共享血量，同时开战。各带座狼暗牙/血爪（顺劈即可，勿急杀）。约 85% / 65% / 50% 解锁新技能；25% 双方嗜血（伤害与急速 +25%）。毒风暴、灰烬墙持续压缩场地。英雄：约 95% 起铁之墓（永久柱）占位；铁之囚笼约 60 秒后致死物理伤，到点前抬满+减伤；可分边降低技能重叠。",
      skills: [
        {
          name: "灵魂链接 / 座狼",
    ...
    },
    {
      ...
      summary: "计时两阶段循环：库卡隆之力约 2 分钟（怒气 0→100）用圆弧斩、地震猛击、聚爆能量等；满怒进入血之怒约 20 秒，近战巨额物理可分摊或坦克叠减伤硬吃。全程「远古瘴气」把治疗转为远古屏障，血之怒期间屏障失效。约 6 分钟硬狂暴。英雄：周期性刷亚煞极精华宝珠（约 3 秒），碰到会引爆并拆掉远古屏障；地震猛击还会刷「活性腐蚀」减速光环，需专人清珠与活性腐蚀。",
      skills: [
        {
          name: "远古瘴气 / 远古屏障",
    ...
    },
    {
      ...
      summary: "无本体 Boss。中控台开战后立刻跳下，避免不稳定防御系统伤害。两队各管半场：一组魔古→螳螂，另一组螳螂→魔古。开箱击杀小怪攒能量拉闸；轻/中/重箱约给 1 / 3 / 14 能量。先开熊猫人箱拿职责增益。超时灭团。英雄：每清完一箱的怪，对侧刷「不稳定火花」，约 10 秒不杀会超新星；血红重组圈除给怪回血外还会伤站在圈内的玩家。",
      skills: [
        {
          name: "开箱与能量 / 跳下",
      ...
      mechanics: [
        ...
        "【英雄】清箱刷对侧火花：开箱节制，语音报「清完」；血红圈伤人勿站。",
      ],
    ...
    },
    {
      ...
      summary: "两阶段循环。P1 可坦：能量满震耳尖啸（团伤+打断），越放越密；尽量拉长第一段 P1，嗜血对齐尖啸。血污玩家（约 <50% 血）足够人数且 10 码内集合进 P2。P2 锁定追人（正面撕咬秒杀），秒狱卒开笼；吞食后强化下一轮 P1。开笼序：阿考里克 → 古莱 → 蒙塔克。英雄：第二次 P1 刷洞穴蝙蝠需接住；第三次 P1 刷饥饿雪人冲锋（躲路径）；每次吞食囚徒索克会回血，需减疗/爆发对冲。",
      skills: [
        {
        ...
        },
        {
          ...
          desc: "第二次 P1：刷被俘洞穴蝙蝠，副坦接住并尽快清。第三次 P1：饥饿雪人场内冲锋，全员躲白道，通常不硬杀。每次 P2 结束吞食囚徒时索克会回血——开减疗、交爆发把血打回来。",
          who: "副坦 / 全员"
        }
      ],
      mechanics: [
        ...
        "P2：风筝、躲正面、秒狱卒开笼。",
        "开笼顺序建议：阿考里克 → 古莱 → 蒙塔克。",
        "【英雄】第 2 次 P1 接蝙蝠；第 3 次 P1 躲雪人；吞食回血用减疗/爆发对冲。",
